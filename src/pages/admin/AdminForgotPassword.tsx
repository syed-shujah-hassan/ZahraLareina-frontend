  ...
  const handleRequestCode = (e: FormEvent) => {
    ...
    const run = async () => {
      try {
        ...
        setMessage(data.message || 'If an admin account with this email exists, a reset code has been sent.');
        setStep('code');
      } catch (err: any) {
  ...
  const handleResetPassword = (e: FormEvent) => {
    ...
    const run = async () => {
      try {
        ...
        setMessage(data.message || 'Your admin password has been updated. You can now sign in.');
